...
<head>
  ...
  <title>Convergent Wireless</title>
...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="{{ URL::asset('DashboardU') }}" class="logo"><img alt="logo" src="{{ URL::asset('img/Oalnet-hc-logo-white-sm.png') }}" style="width: 118px;"></a>
      <!--logo end-->
        ...
        <ul class="sidebar-menu" id="nav-accordion">
         ...
         // $role_first = Session::get('role_first'); 
          ...
          <h5 class="centered"><?php echo"$name_first"; ?></h5>
                        				 ...
                        				 <li class="sub"><a href="{{ url('create_ticket') }}"><i class="fa fa-ticket"></i><span>Help Desk</span></a></li>
         				 <li class="sub"><a href="{{ url('create_ticket') }}"><i class="fa fa-ticket"></i><span>Ticket History</span></a></li>
