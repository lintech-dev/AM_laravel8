    ...
    <footer class="site-footer">
      <div class="text-center">
        <p>
          copyrights @ <strong>2020</strong> LINTECHNOKRATS
        </p>
    ...
    <!--footer end-->
    <?php 
    $emp_name = Session()->get('user_Emp_name');
    ?>
  </section>
  ...
  <script src="{{ URL::asset('lib/zabuto_calendar.js') }}"></script>
    ...
    <script src="{{ URL::asset('lib/raphael/raphael.min.js') }}"></script>
  <script src="{{ URL::asset('lib/morris/morris.min.js') }}"></script>
  <!-- <script src="{{ URL::asset('lib/morris-conf.js') }}"></script> -->
  
<!--   <script type="text/javascript">
    $(document).ready(function() {
      var unique_id = $.gritter.add({
        // (string | mandatory) the heading of the notification
        title: '<?php echo"$emp_name"; ?>',
        // (string | mandatory) the text inside the notification
        text: 'Welcome to ICOME TAX - APAR!',
