...
@endif
         <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <form action="{{ URL::asset('reopen_tic') }}" method="post" enctype="multipart/form-data">
 <input type="hidden" name="_token"   value="{{ csrf_token() }}">
        ...
        <tr><td>Location</td>
           ...
           <tr><td>Old Solution</td>
           <td  colspan="3">
           <?php 
           $solution_sp_up = explode("|",$solution);
           echo "$solution_sp_up[1]<br>$solution_sp_up[2]<br>$solution_sp_up[3]<br>$solution_sp_up[4]<br>$solution_sp_up[5]<br>$solution_sp_up[6]<br>$solution_sp_up[7]<br>$solution_sp_up[8]";
           ?>
           </td>
           </tr>
...
<br>
 ...
 <input type="submit" value="open" name="Open" class="btn btn-theme">
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
