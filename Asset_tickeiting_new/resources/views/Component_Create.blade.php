         ...
         <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i>Component</h4>
  
  
  <form name='form1' action='back-component-upload' onsubmit="return validateForm();" method='post' enctype="multipart/form-data">
<table class="table">
<tr>{{ csrf_field() }}</tr>
<tr>
<td>Component Name</td><td><input type='text' id="tag" name='cname' class='form-control'/></td><td></td>
</tr>
...
<tr>
<td>Min. Quantity</td><td><input type='text' id="tag" name='minquantity' class='form-control'/></td><td></td>
</tr>
